                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-customer-table-filter="search" id="myInput" class="form-control form-control-solid w-250px ps-15" placeholder="Cari Aktifitas Harian" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <!--begin::Add customer-->
                            <a href="{{ route("daily-activity.create") }}" class="btn btn-primary" >Tambah Aktifitas</a>
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
                        <!--begin::Group actions-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Nama Aktifitas</th>
                                <th class="min-w-125px">Lama Aktifitas</th>
                        ...
                        @foreach($dailys as $daily) 
                            <tr>
                                ...
                                <td>{{$daily->tanggal}}</td>                                
                                <td>{{$daily->lokasi}}</td>                                
                                <td>{{$daily->nama_aktivitas}}</td>
                                <td>{{$daily->lama_aktivitas}}</td>
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('daily-activity.show', $daily->id) }}" class="menu-link px-3">View</a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a href="{{ route("daily-activity.edit", $daily->id) }}" class="menu-link px-3">Edit</a>
                                        </div>
                                        <div class="menu-item px-3">
                                            <a href="{{route('daily-activity.delete',$daily->id)}}" id="delete-confirm" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Hapus</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
