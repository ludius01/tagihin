...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 17, 2021 at 12:55 PM
...
INSERT INTO `kabupatens` (`id`, `id_prov`, `nama_kab`, `created_at`, `updated_at`) VALUES
...
--
-- Table structure for table `kondisi_tkm`
--

CREATE TABLE `kondisi_tkm` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `id_user` bigint(20) UNSIGNED NOT NULL,
  ...
  `lama_usaha` bigint(11) NOT NULL,
  `jml_produksi` bigint(11) NOT NULL,
  `omzet` bigint(11) NOT NULL,
  `media_promo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `area_pemasaran` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jml_pekerja` int(11) NOT NULL,
  `bidang_permasalahan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `uraian_masalah` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `pemecahan_masalah` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `kunjungan` (
  ...
  `nama_peserta` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `jenis_usaha` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kondisi_usaha` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `lpj_doks`
--

CREATE TABLE `lpj_doks` (
...
(3, '2021_10_15_111945_create_provinsis_table', 1),
(4, '2021_10_15_112450_create_kabupatens_table', 1),
(5, '2021_10_15_113314_create_tks_table', 1),
(6, '2021_10_15_113413_create_aktiv_absn_table', 1),
(7, '2021_10_15_114005_create_kunjungan_table', 1),
(8, '2021_10_15_114047_create_tkm_table', 1),
(9, '2021_10_15_225456_create_kondisi_tkm_table', 1),
(10, '2021_10_16_152956_create_lpj_doks_table', 2);
...
CREATE TABLE `tkm` (
  ...
  `ide_p_usaha` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `b_usaha` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `tks` (
  ...
  `p_terakhir` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `alamat` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `provinsi` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `kabupaten` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `no_hp` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pmp` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mmp` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `username`, `email`, `email_verified_at`, `password`, `foto`, `is_permission`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'superadmin', 'superadmin@gmail.com', NULL, '$2y$10$eC5FqBZL9b/Xui3kyY.KC.qBWIlwaeQyErhgpG1PoZVfHDHagge/.', 'assets/media/avatars/150-26.jpg', 1, NULL, '2021-10-16 03:45:12', '2021-10-16 03:45:12');
...
--
-- Indexes for table `aktiv_absn`
--
ALTER TABLE `aktiv_absn`
  ADD PRIMARY KEY (`id`),
  ADD KEY `aktiv_absn_id_user_foreign` (`id_user`);
...
--
-- Indexes for table `kondisi_tkm`
--
ALTER TABLE `kondisi_tkm`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kondisi_tkm_id_user_foreign` (`id_user`);
...
ALTER TABLE `kunjungan`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kunjungan_id_user_foreign` (`id_user`);

--
-- Indexes for table `lpj_doks`
--
ALTER TABLE `lpj_doks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `lpj_doks_id_user_foreign` (`id_user`);
...
ALTER TABLE `tkm`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tkm_id_user_foreign` (`id_user`);
...
ALTER TABLE `tks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tks_id_user_foreign` (`id_user`);
...
--
-- AUTO_INCREMENT for table `aktiv_absn`
--
ALTER TABLE `aktiv_absn`
...
--
-- AUTO_INCREMENT for table `kondisi_tkm`
--
ALTER TABLE `kondisi_tkm`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `lpj_doks`
--
ALTER TABLE `lpj_doks`
...
--
-- Constraints for table `aktiv_absn`
--
ALTER TABLE `aktiv_absn`
  ADD CONSTRAINT `aktiv_absn_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `kondisi_tkm`
--
ALTER TABLE `kondisi_tkm`
  ADD CONSTRAINT `kondisi_tkm_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `kunjungan`
--
ALTER TABLE `kunjungan`
  ADD CONSTRAINT `kunjungan_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `lpj_doks`
--
ALTER TABLE `lpj_doks`
  ADD CONSTRAINT `lpj_doks_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tkm`
--
ALTER TABLE `tkm`
  ADD CONSTRAINT `tkm_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `tks`
--
ALTER TABLE `tks`
  ADD CONSTRAINT `tks_id_user_foreign` FOREIGN KEY (`id_user`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
